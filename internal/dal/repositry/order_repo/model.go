...
type LaneOrderTab struct {
	...
	GoodsType     int64           `gorm:"column:goods_type;type:int(11);default:0;NOT NULL" json:"goods_type"`
	...
	OrderStatus   int64           `gorm:"column:order_status;type:tinyint(4);default:0;NOT NULL" json:"order_status"`
	LaneId        int64           `gorm:"column:lane_id;type:int(11);NOT NULL" json:"lane_id"`
